...
import com.jbo.kafka.multiversion.support.kafka.client.protocol.types.ArrayOf;
import com.jbo.kafka.multiversion.support.kafka.client.protocol.types.Field;
import com.jbo.kafka.multiversion.support.kafka.client.protocol.types.Schema;
import com.jbo.kafka.multiversion.support.kafka.client.protocol.types.Type;
...
public class Protocol {
    ...
    public static final Schema METADATA_BROKER_V0 = new Schema(new Field("node_id", Type.INT32, "The broker id."),
                                                   new Field("host", Type.STRING, "The hostname of the broker."),
                                                   new Field("port", Type.INT32,
    ...
    public static final Schema METADATA_BROKER_V1 = new Schema(new Field("node_id", Type.INT32, "The broker id."),
                                                      new Field("host", Type.STRING, "The hostname of the broker."),
                                                      new Field("port", Type.INT32,
                                                        "The port on which the broker accepts requests."),
                                                      new Field("rack", Type.NULLABLE_STRING, "The rack of the broker."));

    public static final Schema PARTITION_METADATA_V1 = PARTITION_METADATA_V0;

    public static final Schema TOPIC_METADATA_V1 = new Schema(new Field("topic_error_code", Type.INT16, "The error code for the given topic."),
                                                              new Field("topic", Type.STRING, "The name of the topic"),
                                                              new Field("is_internal", Type.BOOLEAN,
    ...
    public static final Schema METADATA_RESPONSE_V1 = new Schema(new Field("brokers", new ArrayOf(METADATA_BROKER_V1),
                                                                    "Host and port information for all brokers."),
                                                                 new Field("controller_id", Type.INT32,
    ...
    public static final Schema LIST_OFFSET_RESPONSE_TOPIC_V1 = new Schema(new Field("topic", Type.STRING),
                                                                          new Field("partition_responses",
    ...
    public static final Schema LIST_GROUPS_RESPONSE_GROUP_V0 = new Schema(new Field("group_id", Type.STRING),
                                                                          new Field("protocol_type", Type.STRING));
    public static final Schema LIST_GROUPS_RESPONSE_V0 = new Schema(new Field("error_code", Type.INT16),
    ...
    public static final Schema DESCRIBE_GROUPS_RESPONSE_GROUP_METADATA_V0 = new Schema(new Field("error_code", Type.INT16),
                                                                                       new Field("group_id",
                                                                                                 Type.STRING),
                                                                                       new Field("state",
                                                                                                 Type.STRING,
    ...
    public static final Schema GROUP_COORDINATOR_BROKER_V0 = new Schema(new Field("node_id", Type.INT32, "The broker id."),
                                                                        new Field("host", Type.STRING, "The hostname of the broker."),
                                                                        new Field("port", Type.INT32,
                                                                            "The port on which the broker accepts requests."));

    public static final Schema GROUP_COORDINATOR_RESPONSE_V0 = new Schema(new Field("error_code", Type.INT16),
    ...
    public static final Schema CONTROLLED_SHUTDOWN_PARTITION_V1 = new Schema(new Field("topic", Type.STRING),
                                                                             new Field("partition",
                                                                                       Type.INT32,
                                                                                       "Topic partition id."));

    public static final Schema CONTROLLED_SHUTDOWN_RESPONSE_V1 = new Schema(new Field("error_code", Type.INT16),
    ...
    /* Join group api */
    public static final Schema JOIN_GROUP_REQUEST_PROTOCOL_V0 = new Schema(new Field("protocol_name", Type.STRING),
                                                                           new Field("protocol_metadata", Type.BYTES));
    ...
    public static final Schema JOIN_GROUP_RESPONSE_MEMBER_V0 = new Schema(new Field("member_id", Type.STRING),
                                                                          new Field("member_metadata", Type.BYTES));
    ...
    /* SyncGroup api */
    public static final Schema SYNC_GROUP_REQUEST_MEMBER_V0 = new Schema(new Field("member_id", Type.STRING),
                                                                         new Field("member_assignment", Type.BYTES));
    public static final Schema SYNC_GROUP_REQUEST_V0 = new Schema(new Field("group_id", Type.STRING),
    ...
    public static final Schema SYNC_GROUP_RESPONSE_V0 = new Schema(new Field("error_code", Type.INT16),
                                                                   new Field("member_assignment", Type.BYTES));
    ...
    /* Heartbeat api */
    public static final Schema HEARTBEAT_REQUEST_V0 = new Schema(new Field("group_id", Type.STRING, "The group id."),
                                                                 new Field("group_generation_id",
                                                                           Type.INT32,
                                                                           "The generation of the group."),
                                                                 new Field("member_id",
    ...
    /* Leave group api */
    public static final Schema LEAVE_GROUP_REQUEST_V0 = new Schema(new Field("group_id", Type.STRING, "The group id."),
                                                                   new Field("member_id",
                                                                             Type.STRING,
                                                                             "The member id assigned by the group coordinator."));
    ...
    public static final Schema LEADER_AND_ISR_REQUEST_PARTITION_STATE_V0 =
            new Schema(new Field("topic", Type.STRING, "Topic name."),
                       new Field("partition", Type.INT32, "Topic partition id."),
                       new Field("controller_epoch", Type.INT32, "The controller epoch."),
                       new Field("leader", Type.INT32, "The broker id for the leader."),
                       new Field("leader_epoch", Type.INT32, "The leader epoch."),
                       new Field("isr", new ArrayOf(Type.INT32), "The in sync replica ids."),
                       new Field("zk_version", Type.INT32, "The ZK version."),
    ...
    public static final Schema LEADER_AND_ISR_REQUEST_LIVE_LEADER_V0 =
            new Schema(new Field("id", Type.INT32, "The broker id."),
                       new Field("host", Type.STRING, "The hostname of the broker."),
                       new Field("port", Type.INT32, "The port on which the broker accepts requests."));

    public static final Schema LEADER_AND_ISR_REQUEST_V0 = new Schema(new Field("controller_id", Type.INT32, "The controller id."),
                                                                      new Field("controller_epoch", Type.INT32, "The controller epoch."),
    ...
    public static final Schema LEADER_AND_ISR_RESPONSE_PARTITION_V0 = new Schema(new Field("topic", Type.STRING, "Topic name."),
                                                                                 new Field("partition", Type.INT32, "Topic partition id."),
                                                                                 new Field("error_code", Type.INT16, "Error code."));

    public static final Schema LEADER_AND_ISR_RESPONSE_V0 = new Schema(new Field("error_code", Type.INT16, "Error code."),
                                                                       new Field("partitions",
    ...
    /* Replica api */
    public static final Schema STOP_REPLICA_REQUEST_PARTITION_V0 = new Schema(new Field("topic", Type.STRING, "Topic name."),
                                                                              new Field("partition", Type.INT32, "Topic partition id."));

    public static final Schema STOP_REPLICA_REQUEST_V0 = new Schema(new Field("controller_id", Type.INT32, "The controller id."),
                                                                    new Field("controller_epoch", Type.INT32, "The controller epoch."),
                                                                    new Field("delete_partitions", Type.BOOLEAN,
                                                                              "Boolean which indicates if replica's partitions must be deleted."),
                                                                    new Field("partitions",
                                                                              new ArrayOf(STOP_REPLICA_REQUEST_PARTITION_V0)));

    public static final Schema STOP_REPLICA_RESPONSE_PARTITION_V0 = new Schema(new Field("topic", Type.STRING, "Topic name."),
                                                                               new Field("partition", Type.INT32, "Topic partition id."),
                                                                               new Field("error_code", Type.INT16, "Error code."));

    public static final Schema STOP_REPLICA_RESPONSE_V0 = new Schema(new Field("error_code", Type.INT16, "Error code."),
                                                                     new Field("partitions",
    ...
    public static final Schema UPDATE_METADATA_REQUEST_V0 = new Schema(new Field("controller_id", Type.INT32, "The controller id."),
                                                                       new Field("controller_epoch", Type.INT32, "The controller epoch."),
                                                                       new Field("partition_states",
    ...
    public static final Schema UPDATE_METADATA_REQUEST_END_POINT_V1 =
            ...
            new Schema(new Field("port", Type.INT32, "The port on which the broker accepts requests."),
                       new Field("host", Type.STRING, "The hostname of the broker."),
                       new Field("security_protocol_type", Type.INT16, "The security protocol type."));
    ...
    public static final Schema UPDATE_METADATA_REQUEST_V1 = new Schema(new Field("controller_id", Type.INT32, "The controller id."),
                                                                       new Field("controller_epoch", Type.INT32, "The controller epoch."),
                                                                       new Field("partition_states",
    ...
    public static final Schema UPDATE_METADATA_REQUEST_BROKER_V2 =
                    new Schema(new Field("id", Type.INT32, "The broker id."),
                               ...
                               new Field("rack", Type.NULLABLE_STRING, "The rack"));

    public static final Schema UPDATE_METADATA_REQUEST_V2 =
            new Schema(new Field("controller_id", Type.INT32, "The controller id."),
                       new Field("controller_epoch", Type.INT32, "The controller epoch."),
    ...
    public static final Schema SASL_HANDSHAKE_REQUEST_V0 = new Schema(
            new Field("mechanism", Type.STRING, "SASL Mechanism chosen by the client."));
    ...
    public static final Schema API_VERSIONS_V0 = new Schema(new Field("api_key", Type.INT16, "API key."),
                                                           new Field("min_version", Type.INT16, "Minimum supported version."),
                                                           new Field("max_version", Type.INT16, "Maximum supported version."));

    public static final Schema API_VERSIONS_RESPONSE_V0 = new Schema(new Field("error_code", Type.INT16, "Error code."),
    ...
    public static final Schema CONFIG_ENTRY = new Schema(new Field("config_key", Type.STRING, "Configuration key name"),
        new Field("config_value", Type.STRING, "Configuration value"));

    public static final Schema PARTITION_REPLICA_ASSIGNMENT_ENTRY = new Schema(
        new Field("partition_id", Type.INT32),
        new Field("replicas", new ArrayOf(Type.INT32), "The set of all nodes that should host this partition. The first replica in the list is the preferred leader."));

    public static final Schema TOPIC_ERROR_CODE = new Schema(new Field("topic", Type.STRING), new Field("error_code", Type.INT16));
